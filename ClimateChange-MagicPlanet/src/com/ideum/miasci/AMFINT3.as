package com.ideum.miasci
{
	...
	public class AMFINT3 implements IExternalizable 
	{
		...
		public var val3:int = 0;		
		
		private var padding:ByteArray;
		private var data:int=0;
		
		public function AMFINT3(objectSize:Number=40, clientId:String="", funct:String="", val1:int=0, val2:int=0, val3:int=0)
		{
			...
			messageId = AMFINT3.count++;
			var rawPadding:Number = objectSize - 4 - clientId.length - funct.length  - 4 - 4 - 4 - 4 - 4;
